...
(function () {
	...
	*/
	...
	(function (exports) {
		...
		const ReactStackedCarousel = function () {
		  return React__namespace.createElement("h1", null, "Hello, Ibadan Techies Club");
		};
		exports["default"] = ReactStackedCarousel; 
	} (dist));
	...
	function Examples() {
	  return /*#__PURE__*/jsxRuntimeExports.jsx(ReactStackedCarousel, {});
	}
