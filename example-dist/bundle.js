...
(function () {
	...
	*/
	...
	function ReactStackedPhotos({
	  ...
	  useEffect(() => {
	    var _a;
	    setLast(imagesRef.current ? (_a = imagesRef.current.lastElementChild) === null || _a === void 0 ? void 0 : _a.classList : null);
	    return () => {
	  ...
	  const handleOnClick = event => {
	    if (!active) {
	      ...
	      const clickTargetWidth = clickTarget === null || clickTarget === void 0 ? void 0 : clickTarget.offsetWidth,
	        xCoordInClickTarget = event.clientX - Number(clickTarget === null || clickTarget === void 0 ? void 0 : clickTarget.offsetLeft);
	      let sideClicked = "";
	  ...
	  }, React__namespace.Children.map(React__namespace.Children.toArray(children), (child, index) => {
	    return React__namespace.createElement("div", {
	      key: index,
	      className: `img `,
	      style: isHovering ? Object.assign({}, child.props.isHovering) : Object.assign({}, child.props.default),
	      onMouseOver: handleMouseOver,
	      onMouseOut: handleMouseOver
	    }, child.props.children);
	  }));
	}
	var ReactStackedPhotos_1 = dist.ReactStackedPhotos = ReactStackedPhotos;
	...
	function Examples() {
	  return /*#__PURE__*/jsxRuntimeExports.jsx("div", {
	    className: "main",
	    children: /*#__PURE__*/jsxRuntimeExports.jsxs(ReactStackedPhotos_1, {
	      width: 200,
	      height: 200,
	...
	ReactDOM.render( /*#__PURE__*/jsxRuntimeExports.jsx(Examples, {}), document.querySelector("#root"));
