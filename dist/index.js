...
function ReactStackedPhotos({ children, width, height, }) {
    ...
    const handleOnClick = (event) => {
        if (!active) {
            ...
            const clickTargetWidth = clickTarget === null || clickTarget === void 0 ? void 0 : clickTarget.offsetWidth, xCoordInClickTarget = event.clientX - Number(clickTarget === null || clickTarget === void 0 ? void 0 : clickTarget.offsetLeft);
            let sideClicked = "";
...
exports.ReactStackedPhotos = ReactStackedPhotos;
